<template>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="#" class="brand-link">
            <img
                :src="domain + '/images/AdminLTELogo.png'"
                alt="AdminLTE Logo"
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                <div class="image">
                    <img
                        :src="domain + '/images/user2-160x160.jpg'"
                    ...
                    <li class="nav-item menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a
                                    :href="
                                        domain + '/dashboard/subjects/import'
                                    "
                                    class="nav-link"
                                >
                                    <i class="fa fa-circle nav-icon"></i>
                            ...
                            <li class="nav-item">
                                <a
                                    :href="
                                        domain + '/dashboard/subjects/register'
                                    "
                                    class="nav-link"
                                >
                                    <i class="fa fa-circle nav-icon"></i>
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="#" class="nav-link">
                                            <i
                                                class="fa fa-dot-circle nav-icon"
                                            ></i>
                                            <p>Level 3</p>
                                        </a>
                                    </li>
