                            ...
                            <form id="quickForm" @submit.prevent="register()">
                                <div class="card-body">
                                    <div class="form-group">
                                        <label for="exampleInputFirstName">Teacher Name</label>
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputFirstName">Semester</label>
                                        <select class="form-control" v-model="form.semester">
