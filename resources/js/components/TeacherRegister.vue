                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="teacher-code" v-model="form.teacher_code" placeholder="Teacher Code">
                  </div>
                    <div class="form-group">
...
<script>
    export default {
      data(){
       ...
       submit() {
      this.errors = {};
      axios.post('/teachers/store',  this.form).then(response => {
