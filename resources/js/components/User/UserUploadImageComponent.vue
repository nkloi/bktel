<template>
    <div >
        ...
        <div class="image"  v-if="this.profile_image_url == null">
          <img :src="domain + '/storage/blank avatar.jpg' " class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="image" v-else>
          <img :src="domain + path" class="img-circle elevation-2" alt="User Image" style="max-height:500px; max-width:500px;" >
        </div>
...
export default {
    ...
    methods:{
        ...
        profileUpload(){
            ...
            axios.post( this.domain + "/dashboard/users/upload-user-avatar", data)
            
            .then((response)=>{
                alert('Avatar uploaded!');
                window.location.href = (this.domain + "/dashboard/users/upload-image" );
            }).catch(()=>{
            })
        }
    }
