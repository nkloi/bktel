...
<div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Import Subjects</h6>
        </div>
        <form id="avatar" name="avatar" method="POST" action="{{route('import.subjects')}}" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
