    ...
    <div class="page-wrapper bg-dark p-t-100 p-b-50">
        <div class="wrapper wrapper--w900">
            <div class="card card-6">
                ...
                <div class="card-body">
                    <form method="POST" action="{{route('soupntea')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-row">
                            <div class="name">Teacher Code</div>
                            <div class="value">
                                <input class="input--style-6" type="number" name="teacher_id" placeholder="Teacher code">
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-6" type="number" name="subject_id" placeholder="Subject Code">
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
