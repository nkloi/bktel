...
<div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Import New Subject</h6>
        </div>
        <form id="avatar" name="subject_file" method="POST" action="{{route('import.subjects')}}" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
            ...
            <div class="card-footer">
                <button type="submit" class="btn btn-success btn-user float-right mb-3">Upload New Students</button>
